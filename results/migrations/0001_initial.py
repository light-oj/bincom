# Generated by Django 3.1.3 on 2020-11-03 16:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lga_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='results.lga')),
                ('ward_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='results.ward')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_entered', models.DateTimeField()),
                ('user_ip_address', models.CharField(max_length=50)),
                ('polling_unit_uniqueid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='results.pollingunit')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pollingunit_uniqueid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='results.pollingunit')),
            ],
            options={
                'db_table': 'agentname',
            },
